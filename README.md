<p align="center"><a href="https://unidist.readthedocs.io"><img width=77% alt="" src="https://github.com/modin-project/unidist/blob/master/docs/img/unidist_logo.png?raw=true"></a></p>
...
This will install unidist directly from the repo without you having to manually clone it! Please be aware that these changes have not made it into a release and may not be completely stable.

#### Choosing an execution backend

There are several ways to choose the execution backend for distributing computations.
...
cfg.Backend.put("mpi") # unidist will use MPI backend to distribute computations
import unidist.config as cfg
